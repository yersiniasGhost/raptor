...
log "Getting CC information..."
modem_info=$(send_at_command "AT+CSQ" 3)
log "CSQ  info: $(echo "$modem_info" | tr -d '\r\n' | tr '\0' ' ')"
...
log "Doing Erik's debug"
csq_response=$(send_at_command "AT+CGDCONT?" 3)
log "Erik: $(echo "$csq_response")"
