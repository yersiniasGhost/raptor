...
class SingleRelayController:
    ...
    def __init__(self, chip_label="50004010.fpga_gpio", line_number: int = 1, polarity: str = "high"):
        ...
        """
        if line_number < 1 or line_number > 7:
            raise ValueError("DIO line number must be between 1 and 7")

        self.chip_label = chip_label
        self.line_number = line_number + 21
        self.input_line = 36 + line_number
