...
Performs stress testing on actuators with continuous data logging
"""
...
class TestMetrics:
    ...
    operation_type: str  # 'extend', 'retract', or 'idle'
...
class TestConfiguration:
    ...
    data_sample_rate: float = 0.1  # How often to sample data (seconds)
    position_tolerance: float = 2.0  # Acceptable position error
    movement_timeout: float = 60.0  # Max time to wait for movement completion
...
async def main():
    ...
    config = TestConfiguration(
        ...
        retract_speed=50.0,
        dwell_time=1.0,
        data_sample_rate=0.1,  # Sample every 100ms
